...
import { faBars, faUsers, faPercent, faBoxes, faBuilding, faChartLine, faCrown, faShieldAlt } from '@fortawesome/free-solid-svg-icons';
              ...
              <div className="mb-8">
                <div className="flex items-center justify-between mb-5">
                  ...
                  <button
                    ...
                    className="px-4 py-2 rounded-xl bg-gradient-to-r from-orange-500 to-rose-600 text-white font-bold text-sm hover:shadow-lg transition-all duration-300 hover:scale-105"
                  >
                    View Details →
                  </button>
                </div>
                <div className="bg-white dark:bg-neutral-800 rounded-2xl p-8 border-2 border-stone-200 dark:border-neutral-700 shadow-xl">
                  <div className="text-center text-neutral-500 dark:text-neutral-400">
                    <FontAwesomeIcon icon={faChartLine} className="h-16 w-16 mb-4 text-neutral-300 dark:text-neutral-600" />
                    <p className="font-semibold">No sales data available yet</p>
                    <p className="text-sm mt-2">Sales charts and analytics will appear here</p>
                  </div>
                </div>
              </div>
