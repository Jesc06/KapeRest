              ...
              <div className="flex-1 min-h-0 flex flex-col rounded-2xl bg-stone-50 dark:bg-stone-800 shadow-2xl shadow-black/10 overflow-hidden border border-stone-200 dark:border-stone-700">
                ...
                <div className="overflow-x-auto flex-1">
                  <table className="w-full">
                    <thead className="bg-gradient-to-r from-orange-50 to-amber-50 dark:from-orange-950/30 dark:to-amber-950/30 border-b-2 border-stone-200 dark:border-stone-700">
                      <tr>
                        ...
                        <th className="px-6 py-4 text-center text-xs font-black uppercase tracking-wider text-stone-700 dark:text-stone-300">
                          Status
                        </th>
                        <th className="px-6 py-4 text-center text-xs font-black uppercase tracking-wider text-stone-700 dark:text-stone-300">
                          Actions
                          ...
                          <tr key={branch.id} className="group hover:bg-orange-50/50 dark:hover:bg-orange-950/20 transition-colors duration-200">
                            ...
                            <td className="px-6 py-4">
                              <div className="flex items-center gap-2">
                                ...
                                <span className="text-sm font-bold text-stone-700 dark:text-stone-300">{branch.location}</span>
                              </div>
                            </td>
                            <td className="px-6 py-4">
                              <div className="flex items-center gap-2">
                                <FontAwesomeIcon icon={faUsers} className="h-3.5 w-3.5 text-orange-500" />
                                <span className="text-sm font-bold text-stone-700 dark:text-stone-300">{branch.manager}</span>
                              </div>
                            </td>
