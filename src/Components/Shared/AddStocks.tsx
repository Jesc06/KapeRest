        ...
        <div className={`flex h-screen flex-1 flex-col transition-all duration-300 ${sidebarExpanded ? 'lg:ml-80' : 'lg:ml-28'}`}>
          ...
          <div className="flex-1 overflow-auto px-6 sm:px-8 md:px-12 py-10 sm:py-12">
            <div className="w-full max-w-5xl mx-auto">
              ...
              {/* Form - Flat Design */}
              <form onSubmit={handleSubmit} className="space-y-6 bg-stone-50 dark:bg-stone-900 p-8 rounded-lg border border-neutral-200 dark:border-stone-700 shadow-sm">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <span className="absolute left-3 top-2 text-neutral-500 dark:text-stone-400">₱</span>
                      <input
                        type="number"
                        name="costPrice"
