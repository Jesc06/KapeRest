  ...
  return (
    <div className={`flex h-screen flex-col bg-stone-100 dark:bg-stone-900 transition-all duration-300 ${sidebarExpanded ? 'lg:ml-64' : 'lg:ml-20'}`}>
        ...
        <div className="block lg:hidden">
          <div className="flex items-center justify-between gap-2 mb-3">
            ...
            <button
              ...
              className="flex h-9 w-9 items-center justify-center rounded-lg border border-orange-400/60 bg-orange-50 hover:bg-orange-100 text-orange-700 transition-all duration-200 shadow-sm dark:border-orange-600/40 dark:bg-orange-900/30 dark:hover:bg-orange-900/50 dark:text-orange-300"
            >
          ...
          <div className="flex items-center gap-3 pl-4 bg-gradient-to-r from-orange-500 via-orange-550 to-orange-600 rounded-lg p-2.5 shadow-xl ring-2 ring-orange-400/40 focus-within:ring-orange-300/80 transition-all duration-300 mb-3">
            <FontAwesomeIcon
              icon={faSearch}
            ...
            <input
              ...
              className="flex-1 bg-transparent text-xs font-semibold text-white placeholder:text-white/60 shadow-none focus:outline-none transition-all duration-300"
            />
          </div>
        </div>
      ...
      <div className="flex flex-1 overflow-hidden flex-col gap-4 sm:gap-5 p-4 sm:p-5 md:p-6">
        ...
        <div className="flex flex-wrap gap-3 rounded-lg border border-orange-300/50 dark:border-orange-700/30 bg-gradient-to-r from-orange-50/60 to-orange-100/40 dark:from-orange-900/20 dark:to-orange-900/10 p-4 sm:p-5 shadow-sm">
          <p className="w-full text-xs font-bold uppercase tracking-widest text-orange-700 dark:text-orange-300 mb-1">Generate Reports:</p>
          
          <button
            onClick={() => handleGenerateReport('daily')}
            disabled={isGenerating !== null}
            className={`flex items-center gap-2 rounded-lg px-4 py-2.5 text-xs font-bold uppercase tracking-wider transition-all duration-200 border ${
              isGenerating === 'daily'
                ? 'border-orange-400/50 bg-orange-200/40 text-orange-800 dark:border-orange-400/40 dark:bg-orange-500/20 dark:text-orange-200'
                : 'border-orange-300/60 bg-white dark:bg-stone-800/60 text-orange-700 dark:text-orange-300 hover:border-orange-400/80 hover:bg-orange-50/80 dark:hover:bg-stone-800/80 active:scale-95'
