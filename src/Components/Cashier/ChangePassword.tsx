    ...
    <div className="min-h-screen w-full bg-gradient-to-br from-orange-50 via-white to-amber-50 dark:from-neutral-950 dark:via-neutral-900 dark:to-neutral-950">
      ...
      <div className="relative z-10 flex h-screen overflow-hidden">
        ...
        <div className={`flex h-screen flex-1 flex-col transition-all duration-300 ${sidebarExpanded ? 'lg:ml-80' : 'lg:ml-28'}`}>
          ...
          <div className="sticky top-0 z-20 border-b border-orange-100/50 dark:border-stone-700/50 bg-stone-50/90 dark:bg-stone-900/95 px-4 sm:px-6 md:px-8 py-3.5 sm:py-4 shadow-sm backdrop-blur-xl">
          ...
          <div className="flex-1 overflow-auto px-4 sm:px-6 md:px-8 py-6 sm:py-8">
            <div className="w-full max-w-4xl mx-auto">
              ...
              {/* Form Card */}
              <div className="bg-stone-50 dark:bg-stone-900 rounded-xl border border-neutral-200 dark:border-stone-700 shadow-sm overflow-hidden">
                <div className="p-6 sm:p-8">
                  ...
                  {newPassword && (
                    <div className="space-y-4">
                      ...
                      <div className="bg-neutral-50 dark:bg-stone-800/50 rounded-lg p-4 border border-neutral-200 dark:border-stone-700">
                        <p className="text-sm font-semibold text-stone-700 dark:text-stone-300 mb-3">Password Requirements</p>
                  ...
                  <div className="flex gap-3 pt-4">
                    ...
                    <button
                      ...
                      disabled={isLoading}
                      className="px-6 py-3 bg-neutral-100 dark:bg-stone-800 hover:bg-neutral-200 dark:hover:bg-stone-700 text-stone-700 dark:text-stone-300 text-sm font-semibold rounded-lg transition-all duration-200 shadow-sm hover:shadow-md active:scale-95 disabled:cursor-not-allowed"
                    >
                      Cancel
                    </button>
                  </div>
