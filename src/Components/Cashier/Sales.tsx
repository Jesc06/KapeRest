...
import { faCoffee, faSearch, faBars, faChevronLeft, faChevronRight, faCalendarDays, faWeightScale, faCalendarAlt, faReceipt, faMoneyBillWave, faPercentage, faChartLine } from '@fortawesome/free-solid-svg-icons';
